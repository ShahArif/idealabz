-- EMERGENCY FIX for idea_documents RLS policy issue
-- This script will temporarily disable RLS to test, then set up ultra-permissive policies
...
SELECT 
    'Test insert worked' as check_item,
    CASE 
...
-- Step 4: RE-ENABLE RLS WITH ULTRA-PERMISSIVE POLICIES
...
SELECT 
    'Test insert with RLS worked' as check_item,
    CASE 
...
SELECT 'The table should now allow ideator users to save documents.' as message;
